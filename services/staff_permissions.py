...
ROLE_PERMISSIONS = {
    ...
    "manager": {"cash_sale", "products_view", "products_manage", "cash_view", "athletes_view", "athletes_manage", "schedule_view", "schedule_edit", "tariffs_manage", "qr_checkin", "manual_checkin", "forecast_view", "analytics_view"},
}
